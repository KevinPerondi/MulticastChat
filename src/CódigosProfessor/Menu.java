...
public class Menu {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            msg = new byte[1000];
            Thread threadchat = new Thread(new Recebe(membros, s, apelido));
            threadchat.start();

            Thread armazenaMembros = new Thread(new RecebeUDP(membros, apelido, "/home/todos/alunos/cm/a1552287/Downloads/Arq",meuip));
            ...
            while (true) {
                ...
                switch (opcao) {
                    case 1://mensagem no multicast
                        //System.out.println("(MULTICAST)Digite sua mensagem: ");
                        String x = scanner.nextLine();//tenho que pegar o System.in novamente?
                        x = "MSG [" + apelido + "] " + x;
                        msg = x.getBytes();
